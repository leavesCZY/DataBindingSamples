...
class MainActivity13 : AppCompatActivity() {
    ...
    private var userObservableArrayList: ObservableArrayList<UserBean>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userObservableArrayList!!.addOnListChangedCallback(
            DynamicChangeCallback<UserBean>(
                userAdapter
            )
        )
    ...
    private fun initData() {
        userObservableArrayList = ObservableArrayList<UserBean>()
        for (i in 0..19) {
